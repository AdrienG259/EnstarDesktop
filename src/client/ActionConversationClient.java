...
public class ActionConversationClient {
    ...
    public List<String> getListDatesLastChanges(int conversationID) {
        List<String> listDatesLastChangesClient = new ArrayList<>();
        return listDatesLastChangesClient;
    }
...
//
//    public List<String> getListDatesLastChanges(int conversationID) {
////        List<String> listDatesLastChangesClient = conversation.getListDatesLastChanges();
//        List<String> listDatesLastChangesClient = new ArrayList<>();
//        return listDatesLastChangesClient;
//    }
//
